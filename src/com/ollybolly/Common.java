...
public class Common {
	...
	public String getReplaceFileOriginName(String fileName, String type) {
		...
		if (tmpArr.length == 5) {
			...
			if (type.equals("F")) {
				...
				tmpFile = tmpArr[0] + "/" + tmpArr[1] + "/" + tmpArr[2] + "/"
						+ tmpArr[3] + "/" + tmpArr2[0] + "_b@2x." + tmpArr2[1];
			}
	...
	public String getReplaceFileThumbName(String fileName, String type) {
		...
		if (tmpArr.length == 5) {
			...
			if (type.equals("F")) {
				...
				tmpFile = tmpArr[0] + "/" + tmpArr[1] + "/" + tmpArr[2] + "/"
						+ tmpArr[3] + "/" + tmpArr2[0] + "_s@2x." + tmpArr2[1];
			}
	...
	// ++파일명 _s@2x값 붙여서 리턴하기
	public String getReplaceFileTitleName(String fileName, String type,
			String lang) {
	...
	public String getMovieUrl(String Url, String count) {
		...
		if (tmpArr.length == 5) {
			...
			if (!count.equals("")) {
				tmpUrl = tmpArr[0] + "/" + tmpArr[1] + "/" + tmpArr[2] + "/"
						+ tmpArr[3] + "/" + tmpArr2[0] + "_" + count + "."
						+ tmpArr2[1];
			} else {
				tmpUrl = tmpArr[0] + "/" + tmpArr[1] + "/" + tmpArr[2] + "/"
						+ tmpArr[3] + "/" + tmpArr2[0] + "_1." + tmpArr2[1];
			}
	 ...
	 * @return long 날짜 차이
	 */
	public long day2Day(String startDate, String endDate, String format)
			throws Exception {
		if (format == null)
	...
	public int[] getStoryBtin(String lang, String movie, String count) {
		...
		if (Common.langType.equals("en")) {
			...
			} else if (movie.indexOf("kimsw1") > -1) { 
				tmpStoryBtn[0] = R.drawable.kimsw1_bt1_en;
				if (count.equals("2")) {
					tmpStoryBtn[1] = R.drawable.kimsw1_bt2_en;
				} else {
					tmpStoryBtn[1] = 0;
				}
			} else if (movie.indexOf("songig1") > -1) {
				tmpStoryBtn[0] = R.drawable.songig1_bt1_en;
				if (count.equals("2")) {
					tmpStoryBtn[1] = R.drawable.songig1_bt2_en;
				} else {
					tmpStoryBtn[1] = 0;
				}
			} else if (movie.indexOf("hanmg1") > -1) {
				tmpStoryBtn[0] = R.drawable.hanmg1_bt1_en;
				if (count.equals("2")) {
					tmpStoryBtn[1] = R.drawable.hanmg1_bt2_en;
				} else {
					tmpStoryBtn[1] = 0;
				}
			} else if (movie.indexOf("shinar1") > -1) {
				tmpStoryBtn[0] = R.drawable.shinar1_bt1_en;
				if (count.equals("2")) {
					tmpStoryBtn[1] = R.drawable.shinar1_bt2_en;
				} else {
					tmpStoryBtn[1] = 0;
				}
			} else if (movie.indexOf("yooy1") > -1) {
				tmpStoryBtn[0] = R.drawable.yooy1_bt1_en;
				if (count.equals("2")) {
					tmpStoryBtn[1] = R.drawable.yooy1_bt2_en;
				} else {
					tmpStoryBtn[1] = 0;
				}
			} else if (movie.indexOf("baehs1") > -1) {
				tmpStoryBtn[0] = R.drawable.baehs1_bt1_en;
				if (count.equals("2")) {
					tmpStoryBtn[1] = R.drawable.baehs1_bt2_en;
				} else {
					tmpStoryBtn[1] = 0;
				}
			...
			if (movie.indexOf("cruz1") > -1) {
				...
				tmpStoryBtn[0] = R.drawable.kimsw1_bt1;
				if (count.equals("2")) {
					tmpStoryBtn[1] = R.drawable.kimsw1_bt2;
				} else {
					tmpStoryBtn[1] = 0;
				}
			} else if (movie.indexOf("songig1") > -1) {
				tmpStoryBtn[0] = R.drawable.songig1_bt1;
				if (count.equals("2")) {
					tmpStoryBtn[1] = R.drawable.songig1_bt2;
				} else {
					tmpStoryBtn[1] = 0;
				}
			} else if (movie.indexOf("hanmg1") > -1) {
				tmpStoryBtn[0] = R.drawable.hanmg1_bt1;
				if (count.equals("2")) {
					tmpStoryBtn[1] = R.drawable.hanmg1_bt2;
				} else {
					tmpStoryBtn[1] = 0;
				}
			} else if (movie.indexOf("shinar1") > -1) {
				tmpStoryBtn[0] = R.drawable.shinar1_bt1;
				if (count.equals("2")) {
					tmpStoryBtn[1] = R.drawable.shinar1_bt2;
				} else {
					tmpStoryBtn[1] = 0;
				}
			} else if (movie.indexOf("yooy1") > -1) {
				tmpStoryBtn[0] = R.drawable.yooy1_bt1;
				if (count.equals("2")) {
					tmpStoryBtn[1] = R.drawable.yooy1_bt2;
				} else {
					tmpStoryBtn[1] = 0;
				}
			} else if (movie.indexOf("baehs1") > -1) {
				tmpStoryBtn[0] = R.drawable.baehs1_bt1;
				if (count.equals("2")) {
					tmpStoryBtn[1] = R.drawable.baehs1_bt2;
				} else {
					tmpStoryBtn[1] = 0;
				}
			} else if (movie.indexOf("yoonsh1") > -1) {
