...
public class OllybollyStoryPlay extends Activity {
  ...
  public void checkIntenet(){
		...
		boolean isMobileConn = ni.isConnected();
		 ...
		 // 가져온 값을 set해주는 부분
		 String strMovieUrl = intent.getExtras().getString(Common.VAL_URL).toString();
	   ...
	   // Set video link (mp4 format )
		...
		if(isWifiConn==false && isMobileConn==false)
		{
			 ...
			 alert_internet_status.show();		
				...
				alert_internet_status.setNegativeButton( strBtnCancel, new DialogInterface.OnClickListener() {
			 		public void onClick( DialogInterface dialog, int which) {
			    	   			         dialog.dismiss();   //중지
			    	   			         finish();	 
			 		}
	...
	void createThreadAndDialog()
	{
		...
		pDialog = ProgressDialog.show(OllybollyStoryPlay.this, "", "loading",true,false);
